...
import { FolderOpen, ChevronRight, LogOut, Vault } from "lucide-react";
  ...
  return (
    <header className="flex h-14 items-center justify-between border-b border-border bg-card px-4 shrink-0">
      ...
      <div className="flex items-center gap-2">
        {rootFolder && (
          <div className="hidden sm:flex items-center gap-1.5 text-xs text-muted-foreground bg-muted px-2.5 py-1 rounded-md">
